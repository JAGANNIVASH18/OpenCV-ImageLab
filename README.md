...
- Generating a third image using bitwise operations  
...
### Step 1:
Read an image from the local directory and display it.

### Step 2:
Create a matrix of ones (float64 type) to control the brightness level.

### Step 3:
Increase and decrease the brightness of the image by adding and subtracting the matrix.

### Step 4:
Adjust the contrast of the image using scaling factors of 1.1 and 1.2.

### Step 5:
Split the image into Blue, Green, and Red channels and display each channel.
...
```
### 1. Load the image 'Eagle_in_Flight.jpg' in grayscale mode using OpenCV’s imread() function.
```py
...
---
## Output
i) Image was successfully read and displayed.  
ii) Brightness of the image was adjusted.  
iii) Contrast of the image was modified.  
iv) A third image was generated using bitwise operations.  

---

## Result
Thus, the image processing operations including reading, displaying, brightness adjustment, contrast modification, and bitwise operations were successfully implemented using Python and OpenCV.
